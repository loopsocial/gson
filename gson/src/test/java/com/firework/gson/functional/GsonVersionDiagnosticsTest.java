...
public class GsonVersionDiagnosticsTest {
  ...
  private static final Pattern GSON_VERSION_PATTERN =
      Pattern.compile("(\\(GSON \\d\\.\\d+\\.\\d+\\.\\d)(?:[-.][A-Z]+)?\\)$");
  ...
  public void testVersionPattern() {
    assertTrue(GSON_VERSION_PATTERN.matcher("(GSON 2.8.5.0)").matches());
    assertTrue(GSON_VERSION_PATTERN.matcher("(GSON 2.8.5.0-SNAPSHOT)").matches());
  }
