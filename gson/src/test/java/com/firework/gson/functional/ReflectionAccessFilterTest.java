...
import com.firework.gson.JsonPrimitive;
import com.firework.gson.JsonSerializationContext;
import com.firework.gson.JsonSerializer;
import com.firework.gson.ReflectionAccessFilter;
import com.firework.gson.ReflectionAccessFilter.FilterResult;
...
public class ReflectionAccessFilterTest {
  ...
  public void testBlockAllJavaExtendingJdkClass() {
    ...
    try {
      ...
      assertEquals(
        ...
        + " (supertype of class com.firework.gson.functional.ReflectionAccessFilterTest$ClassExtendingJdkClass)."
        + " Register a TypeAdapter for this type or adjust the access filter.",
        expected.getMessage()
      );
    }
  ...
  public void testBlockInaccessibleStaticField() {
    Gson gson = new GsonBuilder()
      ...
      try {
        ...
        assertEquals(
          "Field 'com.firework.gson.functional.ReflectionAccessFilterTest$ClassWithStaticField#i'"
  ...
  public void testDelegation() {
    ...
    try {
      ...
      assertEquals(
        ...
        + " com.firework.gson.functional.ReflectionAccessFilterTest$SuperTestClass."
        + " Register a TypeAdapter for this type or adjust the access filter.",
        expected.getMessage()
      );
    }
  ...
  public void testAllowForSupertype() {
    ...
    try {
      ...
      assertEquals(
        "Field 'com.firework.gson.functional.ReflectionAccessFilterTest$ClassWithPrivateField#i'"
        + " is not accessible and ReflectionAccessFilter does not permit making it accessible."
        + " Register a TypeAdapter for the declaring type, adjust the access filter or increase"
        + " the visibility of the element and its declaring type.",
        expected.getMessage()
  ...
  public void testInaccessibleNoArgsConstructor() {
    ...
    try {
      ...
      assertEquals(
        "Unable to invoke no-args constructor of class com.firework.gson.functional.ReflectionAccessFilterTest$ClassWithPrivateNoArgsConstructor;"
  ...
  public void testClassWithoutNoArgsConstructor() {
    ...
    try {
      ...
      assertEquals(
        "Unable to create instance of class com.firework.gson.functional.ReflectionAccessFilterTest$ClassWithoutNoArgsConstructor;"
  ...
  public void testBlockAllPartial() {
    ...
    try {
      ...
      assertEquals(
        "ReflectionAccessFilter does not permit using reflection for class com.firework.gson.functional.ReflectionAccessFilterTest$OtherClass."
        + " Register a TypeAdapter for this type or adjust the access filter.",
        expected.getMessage()
      );
    }
