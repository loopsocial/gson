...
import com.firework.gson.FieldNamingPolicy;
...
import com.firework.gson.common.TestTypes.ClassWithSerializedNameFields;
import com.firework.gson.common.TestTypes.StringWrapper;
...
public class NamingPolicyTest {
  ...
  public void testGsonDuplicateNameUsingSerializedNameFieldNamingPolicySerialization() {
    ...
    try {
      ...
      assertEquals(
          "Class com.firework.gson.functional.NamingPolicyTest$ClassWithDuplicateFields declares multiple JSON fields named 'a';"
          + " conflict is caused by fields com.firework.gson.functional.NamingPolicyTest$ClassWithDuplicateFields#a and"
          + " com.firework.gson.functional.NamingPolicyTest$ClassWithDuplicateFields#b",
          expected.getMessage()
      );
    }
  }
